    ...
    //       exit();
        ...
        if(!empty($vessel)){
            foreach($vessel as $key=>$ves){
                ...
                $tcolor = $tcolorETD = $vtcolor = $tcolorLocE =  $matchLoc = $tcolorLocD = $tcolorvsl= '';
                ...
                if(isset($j_ves->status) && $j_ves->status == 'success'){
                    ...
                    if(isset($j_ves->data) && !empty($j_ves->data)){
                        ...
                        //print_r($lastDate );
                        //echo"<br>";
                        if($ves->port_discharge !== $endLocation && $endLocation !==''){
                            // $lastDate = $ves->eta;
                            // $firstDate  = $ves->etd;
                        ...
                        if($ves->port_loading !== $firstLocation && $firstLocation !==''){
                            $tcolorLocE = 'text-danger';
                            $matchLoc = '<span id="matchLocETD-'.$ves->id.'" class="mismatchLocETD d-none">S.Line:'.$firstLocation.'<br>Cargowise:'.$ves->port_loading.'<br></span>';;
                        }
