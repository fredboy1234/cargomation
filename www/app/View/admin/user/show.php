<?php 
$full_name = $this->user_info->first_name . " " . $this->user_info->last_name;
$image_src = "/img/default-profile.png";
if(!empty($this->user_info->image_src)) {
    $image_src = $this->user_info->image_src;
}
// $company_name = $this->user_info->company_name;
$company_name = "A2B";
$organization_code = $this->user_info->organization_code;
$address = $this->user_info->address;
$address .= " " . $this->user_info->city;
$address .= " " . $this->user_info->postcode;
    ...
    <div class="col-md-6">
        ...
        <div class="card card-widget widget-user">
            ...
            <div class="row">
                ...
                <div class="col-sm-4 border-right">
                <div class="description-block">
                    <h5 class="description-header"><?= 1; // $this->document_stats['total_files'][0]->count; ?></h5>
    ...
    <div class="col-md-6">
        <div class="card card-info">
            ...
            <div class="card-body">
                ...
                <p class="text-muted">
                <strong>Email:</strong> <?= $this->user_info->email; ?><br>
                <strong>Phone:</strong> <?= $this->user_info->phone; ?>
                </p>
