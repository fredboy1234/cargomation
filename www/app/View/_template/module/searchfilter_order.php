...
<div class="row">
    ...
    <div class="col-md-6 mt-2">
        <button type="submit" id="searchFilter" class="btn btn-outline-primary"><i class="fas fa-search"></i> Search Data </button>
        <button type="button" id="savefilter" class="btn btn-outline-success"><i class="fas fa-save"></i> Save Search </button>
        <button type="button" id="clearFilter" class="btn btn-outline-danger"><i class="fas fa-trash-alt"></i> Clear Filter </button>
    </div>
