    ...
    <section class="content">
        ...
        <div class="row">
            ...
            <div class="card card-primary">
                ...
                <p class="text-muted float-right"><?= !isset($this->user->user_info[0]->phone)?: "No phone provided";  ?></p>

                <hr>

                <strong><i class="fas fa-map-marker-alt mr-1"></i></strong>

                <p class="text-muted float-right"><?= isset($this->user->user_addr[0]->address)?: "No address provided" ; ?></p>
