...
<div id="document-request" style="display: block;">
    <div class="card card-primary">
        <div class="card-header">
            <h3 class="card-title">Request for <?= $this->view; ?> document </h3>
        ...
        <div class="card-body">
            <form id="comment" action="<?= $this->makeUrl("document/putDocumentRequest"); ?>" method="post">
            ...
            <div class="d-flex justify-content-between">
                ...
                <button type="button" class="btn btn-primary" id="request_submit">Request</button>
            </div>
        </div>
        <!-- /.card-body -->
