...
if(isset($_GET['user_id'])){
	...
	foreach($file_path as $filename) {
		...
		if($dataContext != 'false'){
			...
			array_push($ship_array,$place_delivery,$place_receipt,$consignee,$consignor,$sending_agent,$receiving_agent,removeSingleQuote($receiving_add),removeSingleQuote($sending_add),removeSingleQuote($consignee_add),removeSingleQuote($consignor_add));
