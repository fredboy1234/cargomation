...
<head>
        ...
        <?php include_once('css.script.php');?>
        <style>
    ...
    <body>
        ...
        <!-- START cargomation REVOLUTION SLIDER 6.5.2 --><p class="rs-p-wp-fix"></p>   
...
<!--
                        --><rs-layer
                            id="slider-24-slide-26-layer-2" 
                            data-type="image"
                            data-rsp_ch="on"
                            data-xy="xo:726px,532px,205px,129px;yo:113px,108px,410px,373px;"
                            data-text="w:normal;s:20,12,9,5;l:0,16,12,7;"
                            data-dim="w:869px,512px,311px,214px;h:468px,276px,168px,115px;"
                            data-frame_0="y:100%;"
                        ...
                        --><a
                            id="slider-24-slide-26-layer-7" 
                            class="rs-layer"
                            href="#" target="_self" rel="nofollow"
                            data-type="text"
                            data-rsp_ch="on"
                            data-xy="xo:49px,31px,-82px,-76px;yo:221px,168px,182px,113px;"
                            data-text="w:normal;s:16,14,20,12;l:45,45,24,14;a:center;"
                            data-dim="w:45px,45px,34px,20px;h:45px,45px,34px,20px;"
                            ...
                            data-frame_hover="c:#4571f4;bgc:#fff;bor:90px,90px,90px,90px;sp:800ms;"
                            style="z-index:15;background-color:#4571f4;font-family:Roboto;cursor:pointer;"
                        ><i class="fa fa-facebook" aria-hidden="true"></i> 
                        </a><!--

                        --><a
                            id="slider-24-slide-26-layer-8" 
                            class="rs-layer"
                            href="#" target="_self" rel="nofollow"
                            data-type="text"
                            data-rsp_ch="on"
                            data-xy="x:l,l,l,c;xo:49px,31px,-115px,-300px;yo:282px,226px,241px,148px;"
                            data-text="w:normal;s:16,14,20,12;l:45,45,24,14;a: center;"
                            data-dim="w:45px,45px,34px,20px;h:45px,45px,34px,20px;"
                            data-padding="t:0,0,10,6;r:0,0,10,6;b:0,0,10,6;l:0,0,10,6;"
                            data-border="bor:90px,90px,90px,90px;"
                            ...
                            data-frame_hover="c:#4571f4;bgc:#fff;bor:90px,90px,90px,90px;sp:800ms;"
                            style="z-index:13;background-color:#4571f4;font-family:Roboto;cursor:pointer;"
                        ><i class="fa fa-linkedin" aria-hidden="true"></i> 
                        </a><!--

                        --><a
                            id="slider-24-slide-26-layer-9" 
                            class="rs-layer"
                            href="#" target="_self" rel="nofollow"
                            data-type="text"
                            data-rsp_ch="on"
                            data-xy="xo:49px,31px,-89px,-68px;yo:159px,107px,116px,72px;"
                            data-text="w:normal;s:16,14,20,12;l:45,45,24,14;a:center;"
                            data-dim="w:45px,45px,34px,20px;h:45px,45px,34px,20px;"
                            data-padding="t:0,0,10,6;r:0,0,10,6;b:0,0,10,6;l:0,0,10,6;"
                            data-border="bor:90px,90px,90px,90px;"
                            ...
                            data-frame_1="st:3030;sp:1000;sR:3030;"
                            data-frame_999="o:0;st:w;sR:4970;"
                            data-frame_hover="c:#4571f4;bgc:#fff;bor:90px,90px,90px,90px;sp:800ms;e:power4.inOut;"
                            style="z-index:14;background-color:#4571f4;font-family:Roboto;cursor:pointer;"
                        ><i class="fa fa-twitter" aria-hidden="true"></i> 
                        </a><!--

                        --><rs-layer
                            id="slider-24-slide-26-layer-10" 
                            data-type="text"
                            data-rsp_ch="on"
                            data-xy="xo:20px,10px,-96px,-100px;yo:384px,330px,341px,215px;"
                        ...
                        --><rs-layer
                            id="slider-24-slide-26-layer-11" 
                            class="plusjakartatext"
                            data-type="text"
                            data-rsp_ch="on"
                            data-xy="x:l,l,c,c;xo:220px,108px,0,0;y:m,m,t,t;yo:-130px,-67px,110px,107px;"
                            data-text="w:normal;s:50,32,30,24;l:80,51,44,34;a:left,left,center,center;" 
                            data-frame_0="y:100%;"
                            data-frame_0_mask="u:t;"
                            ...
                            style="z-index: 17; font-family: Poppins; height: auto; width: auto; color: rgb(255, 255, 255); text-decoration: none; white-space: nowrap; min-height: 0px; min-width: 0px; max-height: none; max-width: none; text-align: left; line-height: 76px; letter-spacing: 0px; font-weight: 400; font-size: 47px; transform-origin: 50% 50%; opacity: 1; transform: translate(0px, 0px); visibility: visible;">
                            All-in-one solution<br />for your shipment<br /> management needs. 
                        </rs-layer><!--

                        --><rs-layer
                            id="slider-24-slide-26-layer-12" 
                            data-type="text"
                            data-rsp_ch="on"
                            data-xy="x:l,l,c,c;xo:220px,108px,0,0;y:m,m,t,t;yo:-1px,34px,210px,190px;"
                            data-text="w:normal;s:16,14,18,14;l:28,24,28,24;a:left,left,center,center;"
                            data-frame_0="y:100%;"
                            data-frame_0_mask="u:t;"
                        ...
                        --><rs-layer
                            id="slider-24-slide-26-layer-18" 
                            class="green-btn"
                            data-type="text"
                            data-rsp_ch="on"
                            data-xy="x:l,l,c,c;xo:220px,108px,0,0;y:m;yo:102px,120px,20px,40px;"
                            data-text="w:normal;s:20,14,14,14;l:25,16,22,14;"
                            data-dim="w:500px,320px,500px,400px;h:auto,auto,23px,13px;"
                        ...
                        --><rs-layer
                            id="slider-24-slide-26-layer-19" 
                            data-type="text"
                            data-color="rgba(255, 255, 255, 0.14)"
                            data-rsp_ch="on"
                            data-xy="xo:359px,229px,47px,61px;yo:506px,323px,492px,416px;"
                            data-text="w:normal;s:150,96,72,44;l:150,96,72,44;fw:700;"
                            data-frame_0="o:1;"
                            ...
                            data-loop_0="x:-200px;"
                            data-loop_999="x:200px;crd:t;sp:40000;st:1000;e:sine.inOut;"
                            style="z-index:11;font-family:Roboto;text-transform:uppercase;"
                        >Cargomation 
                        </rs-layer>
                        <rs-layer
                            id="slider-24-slide-26-layer-20" 
                            data-type="image"
                            data-rsp_ch="on"
                            data-xy="xo:33px,21px,15px,9px;yo:-1px,0,0,0;"
                            data-text="w:normal;s:20,12,9,5;l:0,16,12,7;"
                            data-dim="w:469px,300px,227px,140px;h:469px,300px,227px,140px;"
                            data-frame_0="sX:0.9;sY:0.9;"
                        ...
                        --><rs-layer
                            id="slider-24-slide-26-layer-21" 
                            data-type="image"
                            data-rsp_ch="on"
                            data-xy="xo:117px,74px,56px,34px;yo:107px,68px,51px,31px;"
                            data-text="w:normal;s:20,12,9,5;l:0,16,12,7;"
                            data-dim="w:278px,177px,134px,82px;h:278px,177px,134px,82px;"
                        ...
                        --><rs-layer
                            id="slider-24-slide-26-layer-22" 
                            data-type="image"
                            data-rsp_ch="on"
                            data-xy="x:c;xo:-72px,-46px,-34px,-20px;y:m;yo:-88px,-56px,-42px,-25px;"
                            data-text="w:normal;s:20,12,9,5;l:0,16,12,7;"
                            data-dim="w:1060px,678px,515px,317px;h:599px,383px,290px,178px;"
                            data-frame_1="e:power4.inOut;st:2170;sp:1500;sR:2170;"
                            data-frame_999="o:0;st:w;sR:5330;"
                            data-loop_0="o:0;"
                            data-loop_999="sp:2000;e:sine.inOut;yyf:t;"
                            style="z-index:9;"
...
-->						</rs-slide>
            ...
            <script>
                setREVStartSize({c: 'rev_slider_24_1',rl:[1240,1024,778,480],el:[700,448,600,500],gw:[1600,1024,778,480],gh:[700,448,600,500],type:'standard',justify:'',layout:'fullwidth',mh:"0"});
            </script>
        </rs-module-wrap>
                                ...
                                <div class="col-lg-6">
                                    <div class="text-left  ">
                                        <ul class="iq-list wow fadeInRight">
                                            <li><i class="fa fa-check"></i><span>Scale Your Operations</span></li>
                                            <li><i class="fa fa-check"></i><span>Supercharge Sales Team</span></li>
                                            <li><i class="fa fa-check"></i><span>Boost Customer Retention</span></li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="text-left  ">
                                        <ul class="iq-list wow fadeInRight">
                                            <li><i class="fa fa-check"></i><span>Compete with Anyone</span></li>
                                            <li><i class="fa fa-check"></i><span>Real time updates with your shipments</span></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-4 col-md-6 col-sm-6  iq-rmb-50">
                        <div class="logo">
                            <a href="index.html"><img class="img-fluid" src="images/logo-white.png" alt="img"></a>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 mt-4 mt-lg-0 mt-md-0">
                        ...
                        <ul class="menu">
                            ...
                            <li><a href="javascript:void(0)" class="anchor">Request a Demo</a></li>
                        </ul>
                    </div>
                    <div class="col-lg-3 col-md-6 col-sm-6 mt-lg-0 mt-4">
                        ...
                        <ul class="menu">
                            <li>
                                <a href="tel:+0123456789" class="anchor"><i class="fa fa-phone fa1"></i><span class="spanpadding">+0123456789</span></a>
                            </li>
                            <li>
					            <a href="mailto:support@iqnonicthemes.com" class="anchor"><i class="fa fa-envelope fa1"></i><span class="spanpadding">support@cargomation.com</span></a>
                            </li>
                            <li>
                                <a class="anchor"><i class="fa fa-home fa1"></i><span class="spanpadding">Sydney AU</span></a>
                            </li>
                        </ul>
                    </div>
                </div>
